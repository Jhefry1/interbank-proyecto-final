  ...
  return (
    <div className="lp-page">
      ...
      <section className="lp-hero">
        <div className="lp-hero-inner">
          <div className="lp-hero-text">
            <span className="lp-hero-tag">Banca Digital · Banco Interbank</span>
            <h1>Uno de los 4 depas, <br />Puede ser tuyo</h1>
            <p>
             Abre y ahorra en tu Cuenta Millonaria y participa.
             Proximo sorteo 24 de julio. Aplican TyC
            </p>
      ...
      <section className="lp-promo">
        <div className="lp-promo-inner">
          <div>
            ...
            <h2>Solicita hasta 24 cuotas sin interes</h2>
            <p>Solo valido con las marcas afiliadas a nuestra banca, solicitalo y recibe una respuesta en evaluación al instante.</p>
          </div>
          <button className="lp-btn lp-btn-light" onClick={() => navigate('/login')}>
      ...
      <section className="lp-section" id="beneficios">
        <div className="lp-section-head">
          <h2>¿Por qué Banco Interbank?</h2>
          <p>Buscamos ser una plataforma financiera responsable y sostenible,</p>
        </div>
